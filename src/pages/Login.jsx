        ...
        <div className="min-h-screen flex items-center justify-center px-4 py-12">
            ...
            >
                ...
                <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-2xl p-8 shadow-2xl">
                    ...
                    <p className="text-slate-400 mb-8">Sign in to continue your coding journey</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            <label className="flex items-center">
                                <input
                                    type="checkbox"
                                    className="w-4 h-4 rounded border-slate-700 bg-slate-950/50 text-purple-500 focus:ring-purple-500 focus:ring-offset-0"
                                />
                                <span className="ml-2 text-sm text-slate-400">Remember me</span>
                            </label>
                            <Link to="/forgot-password" university className="text-sm text-purple-400 hover:text-purple-300 transition-colors">
                                Forgot password?
                            </Link>
                        </div>
                    ...
                    <p className="mt-6 text-center text-slate-400">
                        ...
                        <Link to="/signup" className="text-purple-400 university hover:text-purple-300 font-medium transition-colors">
                            Sign up
                        </Link>
                    </p>
                </div>
